...
public static class BD {
	...
	public static Block[] blocks = new Block[] {
        ...
        Block.NewGrid("Cobblestone", 6),
        Block.NewPipe("Tree Stem", 4, false),
		

        Block.NewBlock("Wood Planks", 5, false, 0),
        Block.NewBlock("Wood Half Slap", 5, true, 1),
        Block.NewBlock("Wood Third Slap", 5, true, 2),//10
        ...
        Block.NewBlock("Bricks 2", 8, false, 0),
        Block.NewBlock("Bricks 1", 7, false, 0),//15
        Block.NewBlock("Brick Half Slap", 7, true, 1),
        Block.NewBlock("Brick Third Slap", 7, true, 2),
        ...
        Block.NewCustom("Roof", 13, 11, CMode.None, RMode.YAxis, SMode.UVCutoff, true, false, new string[] {"Direction4"}),
        Block.NewCustomSlab("Doorframe", 4, 7, 2, RMode.YAxis, SMode.UVCutoff, true, false, new string[] {"CustomslabID"}),
        Block.NewCustomSlab("Door", 5, 8, 2, RMode.YAxis, SMode.UVCutoff, true, false, new string[] {"CustomslabID"}),
        Block.NewCustomSlab("Windowframe", 4, 9, 2, RMode.YAxis, SMode.UVCutoff, true, false, new string[] { "CustomslabID" }),
        Block.NewCustomSlab("Window", 11, 10, 2, RMode.YAxis, SMode.UVAlpha, true, true, new string[] {"CustomslabID"}),//30
        ...
        Block.NewCustom("Glass", 11, 0, CMode.None, RMode.None, SMode.UVAlpha, true, true, new string[0]),
        Block.NewRounded("Rock", 10),
		Block.NewPipe("Tree Branch", 4, true),
    };	

	//Gibt an wie viele Meshs ein block annehmen kann (im Meshtable)
	public static int[] meshcount = { 192, 192, 63, 3, 1, 1, 16, 1, 1, 1, 1, 1, 1};
}
...
public class Block {
    ...
    public byte id;
    public int textureID;	//ID der ersten Textur im TexturArray, Mesh beinhaltet UVs f�r mehrere Texturen
    public int meshID;		//ID der Zeile der Meshtablelle wo sich die Meshs f�r den Block befinden
    ...
    public Color32 color;		//Farbe f�r LOD renderer
    public string[] dataSize;	//Zus�tzliche Daten mit bezeichnung (StructureId...)

	public bool isTransparent;			  //   
    public float density;				//H�herer Wert �berschreibt niedrigen Wert, Rigidbody und Wasser Vehalten, Explosionswiderstand
	...
	public static Block NewBlock(string blockName, int texture, bool isTransparent, byte slabs) {
    ...
    public static Block NewGrid(string blockName, int texture) {
        return new Block(blockName, texture, 2, 2, 0, true, BType.Custom, CMode.Grid, RMode.None, SMode.UVCutoff, true, false, new string[0]);
	}
    public static Block NewPipe(string blockName, int texture, bool isThin) {
        return new Block(blockName, texture, 1, (isThin?1:0), 0, true, BType.Custom, CMode.Pipe, RMode.AllAxis3, SMode.UVCutoff, true, false, new string[] { "Direction3" });
    }
	...
	//byte meshtype
	//ID Bez(Bsp) Zeilenl�ge der Meshtabelle
	// 0: Kein Connect 1
